...
export class newGenerated1676311736215 implements MigrationInterface {
  name = 'newGenerated1676311736215';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`ssh\` (\`id\` int NOT NULL AUTO_INCREMENT, \`host\` text NOT NULL, \`port\` int NOT NULL, \`username\` text NOT NULL, \`description\` text NOT NULL, \`created_at\` int NOT NULL, \`updated_at\` int NULL, \`deleted_at\` int NULL, \`userEntityId\` int NULL, UNIQUE INDEX \`IDX_5f9264019635e046b092f49c54\` (\`host\`, \`username\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
