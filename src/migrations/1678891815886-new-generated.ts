...
export class newGenerated1678891815886 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`job\` (\`id\` int NOT NULL AUTO_INCREMENT, \`job\` varchar(255) NOT NULL, \`time\` text NOT NULL, \`isActive\` tinyint NOT NULL, \`sshEntityId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
