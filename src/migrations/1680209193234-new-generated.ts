...
export class newGenerated1680209193234 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`job\` (\`id\` int NOT NULL AUTO_INCREMENT, \`sshEntityId\` int NOT NULL, \`job\` varchar(255) NOT NULL, \`time\` longtext NOT NULL, \`isActive\` tinyint NOT NULL, \`isDel\` tinyint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
