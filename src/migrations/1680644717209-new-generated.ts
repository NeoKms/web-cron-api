...
export class newGenerated1680644717209 implements MigrationInterface {
  name = 'newGenerated1680644717209';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`log\` ADD CONSTRAINT \`FK_0d77dc6b44db0da029d2109e185\` FOREIGN KEY (\`jobEntityId\`) REFERENCES \`job\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
