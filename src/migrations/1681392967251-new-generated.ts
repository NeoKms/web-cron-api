...
export class newGenerated1681392967251 implements MigrationInterface {
  name = 'newGenerated1681392967251';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const [user] = await queryRunner.query(
      'insert into user (fio,login,password_hash,phone,rights) values (?,?,?,?,?) returning id',
      [
        'admin',
    ...
    const [org] = await queryRunner.query(
      'insert into organization (name,created_at,ownerEntityId) values (?,?,?) returning id',
